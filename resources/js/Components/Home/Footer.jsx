    ...
    return (
        <footer className="mx-auto max-w-screen-xl bg-white px-4 py-5 text-gray-500 md:px-8">
            <div className="justify-between gap-6 md:flex">
                ...
                <div className="mt-10 flex-1 items-start justify-between space-y-6 sm:flex md:mt-0 md:space-y-0">
                    ...
                    <ul className="space-y-4" key={3105}>
            ...
            <div className="mt-8 items-center justify-between border-t py-6 sm:flex">
