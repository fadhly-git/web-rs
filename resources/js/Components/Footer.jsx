        ...
        <footer className="mx-auto grid h-fit w-full max-w-6xl grid-flow-dense grid-cols-12 items-start py-5 text-slate-100 md:px-8">
            ...
            {footerNavs.map((nav, index) => (
                <Block key={index} className="col-span-4 md:col-span-2">
                    <span className="text-[11px] font-semibold text-slate-100 sm:text-base">
                        {nav.label}
                    </span>
                    <ul className="mt-2">
                        {nav.items.map((item, index) => (
                            <li key={index} className="">
                                <Link
                                    href={item.href}
                                    className="text-[10px] hover:text-indigo-600 hover:underline sm:text-base"
                                >
                                    {item.name}
                                </Link>
                            </li>
                        ...
                        <div className="mt-6 sm:mt-0">
                            <ul className="flex items-center space-x-1">
                                <li className="flex h-fit w-fit items-center justify-center rounded-full border hover:border-2 hover:border-cyan-500 hover:p-1">
                                    <Link href="">
                                        <svg
                                            className="svg-icon h-4 w-4 text-blue-400 md:h-6 md:w-6"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                                fill="none"
                                ...
                                <li className="md:p1 flex h-fit w-fit items-center justify-center rounded-full border hover:border-2 hover:border-cyan-500 hover:p-1">
                                    <Link href="">
                                        <svg
                                            className="svg-icon h-4 w-4 text-blue-700 md:h-6 md:w-6"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                                fill="none"
                                ...
                                <li className="md:p1 flex h-fit w-fit items-center justify-center rounded-full border hover:border-2 hover:border-cyan-500 hover:p-1">
                                    <Link href="">
                                        <svg
                                            className="svg-icon h-4 w-4 text-blue-500 md:h-6 md:w-6"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                                fill="none"
                                ...
                                <li className="md:p1 flex h-fit w-fit items-center justify-center rounded-full border hover:border-2 hover:border-cyan-500 hover:p-1">
                                    <Link href="">
                                        <svg
                                            className="svg-icon h-4 w-4 text-red-600 md:h-6 md:w-6"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                                fill="none"
            ...
            <div className="col-span-full mt-8 place-items-center justify-center border-t py-6 sm:flex">
                <div className="mt-4 text-sm sm:mt-0">
                    &copy; 2025 RS PKU BOJA All rights reserved.
                </div>
            </div>
            <style>{`
                .svg-icon path,
